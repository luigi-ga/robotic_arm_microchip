...
//    TMR_values();   
 ...
 //   while(PB_forward==1);
    ...
    while ((T3CONbits.ON==1) || (T1CONbits.ON==1));
    ...
    while(1)
    {
        ...
        { 
            ...
            case move_forward:
                if((T3CONbits.ON==0) && (T1CONbits.ON==0))
                { 
                    if(PB_forward==1)
                    {
                        R0--;
                    ...
                    {        
                        ...
                        if(PB_up==0) elbow_shoulder_state = move_forward_up;
                        if(PB_down==0) elbow_shoulder_state = move_forward_down;
                    }
                }
            break; 
            ...
            case move_backwards:
                ...
                { 
                    ...
                    else //(PB_2==0
                    {
                        ...
                        if(PB_up==0) elbow_shoulder_state = move_backwards_up;
                        if(PB_down==0) elbow_shoulder_state = move_backwards_down;
                    }
                }
            break;    
            ...
            case move_up:
                ...
                { 
                    ...
                    else 
                    {
                        ...
                        if(PB_forward==0) elbow_shoulder_state = move_forward_up;
                        if(PB_backward==0) elbow_shoulder_state = move_backwards_up;
                    }
                }
            break; 
            ...
            case move_down:
                ...
                { 
                    ...
                    else 
                    {
                        ...
                        if(PB_forward==0) elbow_shoulder_state = move_forward_down;
                        if(PB_backward==0) elbow_shoulder_state = move_backwards_down;
                    }
                }
            break; 
...
//                grip_motors_off();
                ...
                if(PB_open==0)//&&(fine_corsa == spento))
                {
                    grip_steps++;                    
                    G_start_check();
                    grip_state = open;
                ...
                if(PB_close==0)//&&(fine_corsa == spento))
                {
                    grip_steps--;                   
                    G_start_check();
                    grip_state = close;
...
//                
//            case roll_cw:
//                if((T4CONbits.ON==0) && (T6CONbits.ON==0))
//                {                     
//                    if(PB_forward==0)
//                    {
//                        roll_state = stopped;
